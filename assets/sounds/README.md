...
2. Cari sound effect "Funky and Jazzy Gang Loop" atau sound funky/jazzy lainnya
3. Download file MP3
4. Rename menjadi: `battle-bg-music.mp3`
5. Letakkan di folder ini (`assets/sounds/battle-bg-music.mp3`)

### Alternative Sounds:
Jika tidak menemukan sound yang tepat, berikut beberapa keyword pencarian:
- "funky loop"
- "jazzy background"
- "upbeat game music"
- "energetic loop"
