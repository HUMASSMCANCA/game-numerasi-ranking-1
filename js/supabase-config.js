...
// ============================================================
var SUPABASE_URL = 'https://idiirkgaqnnlushzfsmp.supabase.co';
var SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlkaWlya2dhcW5ubHVzaHpmc21wIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODczNzcwMjksImV4cCI6MjEwMjk1MzAyOX0.nqfYprxP0uZbvhd9KvDJDvKCno1KbzonOmyvFTUfmKg';

// Client instance — named differently to avoid shadowing window.supabase (the library)
var supabaseClient = null;

function initSupabase() {
  // window.supabase is the library loaded from CDN
